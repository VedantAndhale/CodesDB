...
remove the square brackets as this brac makes it a single list which is a single argument
...
the seq uence is wrong you van write it as (300,5) or (time=5,distance=300)
"""

...
class Account {
	...
	void showMenu() {
		...
		public static void main(String args[]) {
			...
			int PIN = sc.nextInt();
			if (PIN == 1209) {
				Account Bhavesh = new Account("Bhavesh Duse", "A00001");
				Bhavesh.showMenu();
			} else if (PIN == 1210) {
				Account Swayam = new Account("Swayam Shah", "B00002");
				Swayam.showMenu();
			} else if (PIN == 1211) {
				Account Shivam = new Account("Shivam Yadav", "C00003");
				Shivam.showMenu();
			} else if (PIN == 1212) {
				Account Saish = new Account("Saish  Gholap", "B00002");
				Saish.showMenu();
			} else {
